...
CUDA_VISIBLE_DEVICES=$GPU python src/main.py  exp_name=debug exp_id=burgerstypev1 use_wandb=0 eval_size_get=2560  train_size_get=2560  batch_size=64 batch_size_eval=512 n_steps_per_epoch=2000 max_epoch=15  data.train_types=$b_type data.eval_types=$b_type model.name=prose
